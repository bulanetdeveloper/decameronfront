<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Editar Región</h3>
      <form @submit.prevent="updateRegion" style="width:500px; margin: auto;">
...
export default {
  ...
  methods: {
    ...
    updateRegion() {
      axios.put(`http://localhost:3000/decameron/API/update_region.php?Id=${this.$route.params.id}&Nombre=${this.nombre}`, {
        nombre: this.nombre
      })
      .then(() => {
