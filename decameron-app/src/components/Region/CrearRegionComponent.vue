<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Crear Region</h3>
      <br>
      <form @submit.prevent="createRegion" style="width:500px; margin: auto;">
...
export default {
  ...
  methods: {
    createRegion() {
      axios.post('http://localhost:3000/decameron/API/create_region.php?Nombre='+this.nombre, {
        nombre: this.nombre
      })
      .then(() => {
