<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Regiones</h3>
      <br>
      <br>
      <p style="margin-left: 570px;"><a><router-link to="/regiones/nuevaregion">Crear Nuevo Registro</router-link></a></p>
      <table style="width:400px; margin: auto;" class="table">
        ...
        <tbody>
          <tr v-for="region in regiones" :key="region.id">
            <td>{{ region.id }}</td>
            <td>{{ region.nombre }}</td>
            <td><a :href="'/#/regiones/editarregion/' + region.id">Editar</a></td>
            <td><a :href="'/#/regiones/eliminarregion/' + region.id">Eliminar</a></td>
            <td><a :href="'/#/regiones/detalleregion/' + region.id">Detalle</a></td>
          </tr>
        </tbody>
      </table>
    </div>
