  ...
  <div>
    ...
    <form @submit.prevent="createCliente" style="width:500px; margin: auto;">
      ...
      <div class="form-group">
        ...
        <a href="#/clientereserva" @click="fetchCliente">Buscar</a>
      </div>
      <div class="form-group">
        <label for="nombre">Nombres:</label>
        <input type="text" class="form-control" id="numdoc" v-model="nombres" disabled/>
      </div>
      <div class="form-group">
        <label for="nombre">Apellidos:</label>
        <input type="text" class="form-control" id="numdoc" v-model="apellidos" disabled/>
      </div>
      <div class="form-group">
        <label for="nombre">Telefono:</label>
        <input type="text" class="form-control" id="numdoc" v-model="telefono" disabled/>
      </div>
      <div class="form-group">
      <label for="nombre">Email:</label>
        <input type="text" class="form-control" id="numdoc" v-model="email" disabled/>
      </div>
      <div class="form-group">
      ...
      <label for="tipohabitaciones">Tipo Habitacion/Acomodación:</label>
        ...
        <br>
        <a href="#/clientereserva" @click="fetchHabitaciones">Buscar Habitaciones</a>
      </div>
      <div class="form-group">
