<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Tipos de Habitaciones</h3>
      <br>
      <br>
      <p style="margin-left: 520px;"><a><router-link to="tipohabitaciones/nuevotipohabitacion">Crear Nuevo Registro</router-link></a></p>
      <table style="width:500px; margin: auto;" class="table">
        ...
        <tbody>
          <tr v-for="tipohabitacion in tipohabitaciones" :key="tipohabitacion.id">
            <td>{{ tipohabitacion.id }}</td>
            <td>{{ tipohabitacion.nombre }}</td>
            <td>{{ tipohabitacion.acomodacion }}</td>
            <td><a :href="'/#/tipohabitaciones/editartipohabitacion/' + tipohabitacion.id">Editar</a></td>
            <td><a :href="'/#/tipohabitaciones/eliminartipohabitacion/' + tipohabitacion.id">Eliminar</a></td>
            <td><a :href="'/#/tipohabitaciones/detalletipohabitacion/' + tipohabitacion.id">Detalle</a></td>
          </tr>
        </tbody>
      </table>
    </div>
