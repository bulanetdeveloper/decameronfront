<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Crear Tipo de Habitación</h3>
      <br>
    <form @submit.prevent="createTipoHabitacion" style="width:500px; margin: auto;">
      <div class="form-group">
        <label for="nombre">Nombre</label>
        <input type="text" class="form-control" id="nombre" v-model="nombre">
      </div>
      <div class="form-group">
          <label for="nombre">Acomodación:</label>
...
methods: {
  createTipoHabitacion() {
    axios.post('http://localhost:3000/decameron/API/create_tipohabitacion.php?Nombre='+this.nombre + '&Acomodacion=' + this.acomodacion,  {
      nombre: this.nombre,
