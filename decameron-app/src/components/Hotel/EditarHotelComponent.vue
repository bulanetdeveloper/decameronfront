<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Editar Hotel</h3>
      <br>
      <form @submit.prevent="editHotel" style="width:500px; margin: auto;">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="direccopm" v-model="direccion" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        <label for="cantHab">N° Habs:</label>
        <input type="text" class="form-control" id="cantHab" v-model="cantHab" disabled/>
        </div>
        <br>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      fetchHotel() {
      axios.get(`http://localhost:3000/decameron/API/get_hotel.php?Id=${this.$route.params.id}`)
        .then(response => {
          this.hotel = response.data;
          this.nombre = this.hotel.nombre;
          this.direccion = this.hotel.direccion;
          this.telefono = this.hotel.telefono;
          this.ciudadId = this.hotel.ciudadid
          this.regionId = this.hotel.regionid;
          this.cantHab = this.hotel.canthab;
        });
    },
      editHotel() {
        ...
        .then(response => {
          ...
          this.regionId = this.ciudad.regionid;
            ...
            axios.put('http://localhost:3000/decameron/API/update_hotel.php?Id=' + this.$route.params.id + '&Nombre='+ this.nombre +'&Direccion='+ this.direccion +'&Telefono='+ this.telefono +'&CiudadId='+ this.ciudadId +'&RegionId='+ this.regionId +'&CantHab='+ this.cantHab, {
