<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Detalles de Hotel</h3>
      <h4 style="text-align: center;">Desea Eliminar el Registro?</h4>
      <br>
      <form @submit.prevent="deleteHotel" style="width:500px; margin: auto;">
        <div class="form-group">
            ...
            <p>N° Habitaciones: {{ hotel.canthab }}</p>
            <br>
            <br>
            <button type="submit" class="btn btn-primary">Eliminar</button>
            <br>
            <router-link to="/hoteles">Regresar a la lista</router-link>
        </div>
      </form>
    </div>
  </template>
  ...
  export default {
    ...
    deleteHotel() {
        axios.delete(`http://localhost:3000/decameron/API/delete_hotel.php?Id=${this.$route.params.id}`)
          .then(() => {
