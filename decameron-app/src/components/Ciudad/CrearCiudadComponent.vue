<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Crear Ciudad</h3>
      <br>
      <form @submit.prevent="createCiudad" style="width:500px; margin: auto;">
...
export default {
  ...
  methods: {
    createCiudad() {
      axios.post('http://localhost:3000/decameron/API/create_ciudad.php?Nombre='+ this.nombre + '&RegionId=' + this.regionId, {
        nombre: this.nombre,
