<template>
  <div>
    ...
    <br>
    <h3 style="text-align: center;">Crear Estado Habitación</h3>
    <br>
    <form @submit.prevent="createEstadoHabitacion" style="width:500px; margin: auto;">
...
methods: {
  createEstadoHabitacion() {
    axios.post('http://localhost:3000/decameron/API/create_estadohabitacion.php?Nombre='+this.nombre, {
      nombre: this.nombre
    })
    .then(() => {
