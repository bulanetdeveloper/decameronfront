<template>
    <div>
      ...
      <br>
      <h3 style="text-align: center;">Tipos de Documentos</h3>
      <br>
      <br>
      <p style="margin-left: 570px;"><a><router-link to="/tipodocumentos/nuevotipodocumento">Crear Nuevo Registro</router-link></a></p>
      <table style="width:400px; margin: auto;" class="table">
        ...
        <tbody>
          <tr v-for="tipodocumento in tipodocumentos" :key="tipodocumento.id">
            <td>{{ tipodocumento.id }}</td>
            <td>{{ tipodocumento.nombre }}</td>
            <td><a :href="'/#/tipodocumentos/editartipodocumento/' + tipodocumento.id">Editar</a></td>
            <td><a :href="'/#/tipodocumentos/eliminartipodocumento/' + tipodocumento.id">Eliminar</a></td>
            <td><a :href="'/#/tipodocumentos/detalletipodocumento/' + tipodocumento.id">Detalle</a></td>
          </tr>
        </tbody>
      </table>
    </div>
